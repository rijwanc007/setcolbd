                                        ...
                                        <Navbar.Collapse id="basic-navbar-nav">
                                            <Nav style={{marginLeft:'7%'}}>
                                                ...
                                                <NavDropdown title="Products" className={'drop_down_nav_bar'} id="basic-nav-dropdown">
                                                    <NavDropdown.Item><Link to="/erp" className={'drop_down_item_color'}>Enterprise Resource Planing (ERP)</Link></NavDropdown.Item>
                                                    ...
                                                    <NavDropdown.Item><Link to="/crm" className={'drop_down_item_color'}>Customer Relationship Management (CRM)</Link></NavDropdown.Item>
